...
public class Reader extends Controller {
    ...
    */
    public static Result refresh() {
       ...
       return redirect(routes.Reader.index(global, newsGlobal));
    }
    ...
    public static Result techmeme() {
       ...
       return redirect(routes.Reader.index(global, "Tech Meme"));
    }
    ...
    public static Result hindu() {
       ...
       return redirect(routes.Reader.index(global, "Hindu News Update"));
    }
    ...
    public static Result toi() {
       ...
       return redirect(routes.Reader.index(global, "Times of India"));
    }
    ...
    public static Result bbc() {
       ...
       return redirect(routes.Reader.index(global, "BBC Top Stories"));
    }
}
